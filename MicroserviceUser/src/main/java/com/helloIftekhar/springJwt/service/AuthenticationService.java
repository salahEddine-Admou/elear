...
System.out.println("hii");
    ...
    public AuthenticationResponse authenticate(User request) {
        ...
        if (user == null){
            return new AuthenticationResponse(null, user.getRole(), user.getId(), user.getFullName());
        }
        else {
 ...
 System.out.println(user.getRole());
                return new AuthenticationResponse(jwt, user.getRole(), user.getId(), user.getFullName());
